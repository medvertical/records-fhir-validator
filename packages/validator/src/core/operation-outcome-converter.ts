...
// ============================================================================
// HL7 Issue-Type ValueSet Codes
// ============================================================================

/**
 * Maps Records' internal issue codes to HL7 issue-type ValueSet codes.
 *
 * HL7 issue-type hierarchy (https://www.hl7.org/fhir/valueset-issue-type.html):
 *   invalid → structure, required, value, invariant
 *   security → login, unknown, expired, forbidden, suppressed
 *   processing → not-supported, duplicate, multiple-matches, not-found,
 *                deleted, too-long, code-invalid, extension, too-costly,
...
const HL7_ISSUE_TYPE_SYSTEM = 'http://hl7.org/fhir/issue-type';

/** Records custom code system URI */
const RECORDS_CODE_SYSTEM = 'https://records.medvertical.com/fhir/issue-code';
