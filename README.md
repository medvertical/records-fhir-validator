...
```yaml
- uses: medvertical/records-fhir-validator@v0.1.9
  with:
...
| Exact released version | `medvertical/records-fhir-validator@v0.1.9` | Immutable consumer tag |
...
```sh
npm install @records-fhir/validator@0.1.9 @records-fhir/validation-types@0.1.3
```
...
- `@records-fhir/validator` 0.1.9 - Apache-2.0 validation engine.
- `@records-fhir/validation-types` 0.1.3 - Apache-2.0 validation-domain types.
